...
ephys_df['SST & Slc17a8 Positive'] = ephys_df['SST & Slc17a8 Positive'].astype(bool)

fig = plt.figure()
gs = fig.add_gridspec(1, 2)
ax1 = fig.add_subplot(gs[0,0:1])
ax2 = fig.add_subplot(gs[0,1])
sns.scatterplot(x='SST Log2 CPM',
                y='Slc17a8 Log2 CPM',
...
coloc_transgenic = ephys_df['SST Positive'] & (ephys_df['label'] == 'VGlut3-EYFP')
